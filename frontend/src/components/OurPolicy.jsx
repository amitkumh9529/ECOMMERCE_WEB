  ...
  return (
    <div className='flex flex-col sm:flex-row justify-around gap-12 sm:gap-2 text-center p-20 text-xs sm:text-sm md:text-base text-gray-700'>
        <div>
            ...
            <p className='font-symbol'> Easy Exchange Policy </p>
            <p className='text-gray-400'>We offer hassle free exchange policy</p>
        </div>
        <div>
            <img className='w-12 m-auto mb-5' src={assets.quality_icon} alt="" />
            <p className='font-symbol'> Quality </p>
            <p className='text-gray-400'>We offer Premium Quality</p>
        </div>
        <div>
            <img className='w-12 m-auto mb-5' src={assets.support_img} alt="" />
            <p className='font-symbol'> Customer Support </p>
            <p className='text-gray-400'>We offer hassle free Support</p>
        </div>
